...
Return the `skill.yaml` outputs (counter_messaging_strategy, message_variants_table) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
