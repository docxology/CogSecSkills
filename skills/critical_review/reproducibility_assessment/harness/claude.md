...
Return the `skill.yaml` outputs (reproducibility_scorecard, gap_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
