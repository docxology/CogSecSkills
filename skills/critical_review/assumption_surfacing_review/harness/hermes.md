# Hermes adapter — Assumption Surfacing Review
...
Return the `skill.yaml` outputs (assumption_register, assumption_review_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
