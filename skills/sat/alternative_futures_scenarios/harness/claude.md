...
Return the `skill.yaml` outputs (scenario_matrix, scenario_narratives, indicator_set, strategy_stress_test) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
