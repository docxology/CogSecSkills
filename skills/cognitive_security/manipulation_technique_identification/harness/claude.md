...
Return the `skill.yaml` outputs (technique_catalogue, analysis_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
