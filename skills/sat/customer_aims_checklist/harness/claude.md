...
Return the `skill.yaml` outputs (aims_worksheet, gap_and_misalignment_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
