...
Return the `skill.yaml` outputs (adversary_frame, courses_of_action, mirror_imaging_flags) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
