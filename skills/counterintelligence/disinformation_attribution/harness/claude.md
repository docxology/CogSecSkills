...
Return the `skill.yaml` outputs (attribution_matrix, attribution_assessment, intelligence_gaps) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
