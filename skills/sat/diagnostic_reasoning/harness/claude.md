...
Return the `skill.yaml` outputs (diagnostic_table, updated_ranking, diagnostic_value_assessment) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
