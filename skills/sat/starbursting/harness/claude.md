...
Return the `skill.yaml` outputs (question_map, key_unknowns_summary) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
