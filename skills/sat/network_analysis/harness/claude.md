...
Return the `skill.yaml` outputs (centrality_report, structural_findings, collection_gaps) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
