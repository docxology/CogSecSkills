# Claude Code adapter — Platform Affordance Risk Assessment
...
Return the `skill.yaml` outputs (affordance_risk_matrix, risk_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
