...
Return the `skill.yaml` outputs (competency_gap_map, intervention_recommendations) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
