...
Return the `skill.yaml` outputs (insider_threat_indicator_review_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
