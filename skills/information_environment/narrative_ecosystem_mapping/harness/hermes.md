# Hermes adapter — Narrative Ecosystem Mapping
...
Return the `skill.yaml` outputs (narrative_inventory, ecosystem_map) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
