...
Return the `skill.yaml` outputs (analytic_matrix, pattern_summary) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
