...
Return the `skill.yaml` outputs (detection_report, indicator_table) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
