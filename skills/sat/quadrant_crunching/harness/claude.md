...
Return the `skill.yaml` outputs (scenario_matrix, scenario_narratives, neglected_cells) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
