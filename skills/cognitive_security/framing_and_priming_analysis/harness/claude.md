# Claude Code adapter — Framing & Priming Analysis
...
Return the `skill.yaml` outputs (frame_inventory, reframing_brief) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
