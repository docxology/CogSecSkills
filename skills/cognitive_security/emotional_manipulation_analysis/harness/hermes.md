# Hermes adapter — Emotional Manipulation Analysis
...
Return the `skill.yaml` outputs (emotional_lever_map, defensive_brief) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
