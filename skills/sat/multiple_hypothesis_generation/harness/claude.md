...
Return the `skill.yaml` outputs (hypothesis_set, completeness_check) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
