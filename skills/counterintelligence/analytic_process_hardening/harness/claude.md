...
Return the `skill.yaml` outputs (vulnerability_map, hardening_plan, residual_risk_statement) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
