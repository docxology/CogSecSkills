...
Return the `skill.yaml` outputs (case_comparison_table, lessons_and_predictions) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
