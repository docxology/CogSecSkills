...
Return the `skill.yaml` outputs (cross_impact_matrix, loop_inventory, leverage_ranking, analytic_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
