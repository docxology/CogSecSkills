# Claude Code adapter — Dataset Provenance Audit
...
Return the `skill.yaml` outputs (provenance_audit_report, integrity_check_results) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
