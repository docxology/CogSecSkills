# Codex adapter — Calibrated Estimation
...
Return the `skill.yaml` outputs (calibrated_estimate) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
