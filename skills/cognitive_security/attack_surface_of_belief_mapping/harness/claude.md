...
Return the `skill.yaml` outputs (belief_attack_surface_map, priority_interventions) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
