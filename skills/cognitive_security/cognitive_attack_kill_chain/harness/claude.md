...
Return the `skill.yaml` outputs (kill_chain_map, defender_action_plan, residual_uncertainty_log) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
