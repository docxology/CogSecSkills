...
Return the `skill.yaml` outputs (provenance_chain, origin_assessment) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
