...
Return the `skill.yaml` outputs (argument_map, fallacy_register, coherence_verdict) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
