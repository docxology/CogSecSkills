...
Return the `skill.yaml` outputs (statistical_findings_table, corrected_inference) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
