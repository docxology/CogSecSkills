# Hermes adapter — Citation Integrity Review
...
Return the `skill.yaml` outputs (citation_audit_table, integrity_summary) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
