...
Return the `skill.yaml` outputs (indicators_matrix, indicators_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
