...
## Failure modes
- Signposts of Change: declaring the watch-list valid while including signposts consistent with every scenario, adjusting observation thresholds after results are known to protect the preferred trajectory, or treating a missing expected signpost as uninformative, so the monitoring system loses diagnostic value and fails to warn of the trajectory shift it was built to catch.
