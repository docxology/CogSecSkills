...
Return the `skill.yaml` outputs (narrative_competition_map, competition_assessment_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
