...
Return the `skill.yaml` outputs (technique_classification_table, analytical_interpretation) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
