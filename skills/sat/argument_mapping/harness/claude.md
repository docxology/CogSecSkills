...
Return the `skill.yaml` outputs (argument_map, load_bearing_assumption_list, logical_gap_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
