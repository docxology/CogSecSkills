...
Return the `skill.yaml` outputs (chronology, gap_and_anomaly_report, key_findings) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
