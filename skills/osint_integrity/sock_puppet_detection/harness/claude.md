...
Return the `skill.yaml` outputs (indicator_assessment, inauthenticity_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
