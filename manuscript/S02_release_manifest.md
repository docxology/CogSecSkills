...
| Archive DOI | concept `10.5281/zenodo.20804585`; version `10.5281/zenodo.20804586` (v1.0.0); v1.3.0 version DOI unavailable in this snapshot |
...
| `ruff format --check src/cogsecskills tests` | `66 files already formatted` |
