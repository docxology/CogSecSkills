...
Return the `skill.yaml` outputs (fallacy_catalogue, argument_assessment) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
