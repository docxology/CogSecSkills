# Hermes adapter — Elicitation Attempt Recognition
...
Return the `skill.yaml` outputs (elicitation_recognition_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
