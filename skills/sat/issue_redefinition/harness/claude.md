...
Return the `skill.yaml` outputs (restatements_register, preferred_framing) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
