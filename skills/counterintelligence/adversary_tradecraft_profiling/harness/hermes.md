# Hermes adapter — Adversary Tradecraft Profiling
...
Return the `skill.yaml` outputs (tradecraft_profile, anticipatory_indicators, profile_caveats) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
