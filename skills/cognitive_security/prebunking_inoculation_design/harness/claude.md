...
Return the `skill.yaml` outputs (inoculation_content, efficacy_check_items, design_rationale) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
