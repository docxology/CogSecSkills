...
Return the `skill.yaml` outputs (laundering_chain, analysis_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
