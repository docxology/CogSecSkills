...
The panels are mutually independent — each owns a single figure end to end and
shares only the theme tokens and the helpers, which is why they split cleanly
out of the former single-module ``figures.py``.
"""
