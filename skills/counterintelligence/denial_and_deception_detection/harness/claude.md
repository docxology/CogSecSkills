# Claude Code adapter — Denial & Deception Detection
...
Return the `skill.yaml` outputs (dd_assessment, deception_indicators, collection_recommendations) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
