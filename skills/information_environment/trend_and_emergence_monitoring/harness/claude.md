...
Return the `skill.yaml` outputs (signal_log, monitoring_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
