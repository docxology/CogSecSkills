...
Return the `skill.yaml` outputs (gap_report, assumption_register, revised_scope_recommendation) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
