...
Return the `skill.yaml` outputs (claim_evidence_table, audit_summary) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
