# Claude Code adapter — Research Design Critique
...
Return the `skill.yaml` outputs (validity_critique, inferential_reach_assessment) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
