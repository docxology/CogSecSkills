# Claude Code adapter — Epistemic Security Posture Review
...
Return the `skill.yaml` outputs (posture_scorecard, attack_surface_narrative, remediation_roadmap) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
