# Claude Code adapter — Mind Maps & Concept Maps
...
Return the `skill.yaml` outputs (concept_graph, gap_and_conflict_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
