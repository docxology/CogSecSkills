...
Return the `skill.yaml` outputs (deception_assessment_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
