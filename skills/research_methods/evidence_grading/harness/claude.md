# Claude Code adapter — Evidence Grading
...
Return the `skill.yaml` outputs (graded_evidence_table, weight_of_evidence_summary) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
