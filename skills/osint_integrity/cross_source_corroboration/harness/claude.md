# Claude Code adapter — Cross-Source Corroboration
...
Return the `skill.yaml` outputs (corroboration_assessment, promotion_decision) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
