...
Return the `skill.yaml` outputs (findings_table, security_review_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
