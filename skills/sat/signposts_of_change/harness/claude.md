...
Return the `skill.yaml` outputs (signpost_matrix, collection_guidance, update_protocol) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
