...
Return the `skill.yaml` outputs (metadata_assessment, integrity_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
