...
Return the `skill.yaml` outputs (vulnerability_catalog, red_team_narrative) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
