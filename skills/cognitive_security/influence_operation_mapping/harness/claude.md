...
Return the `skill.yaml` outputs (abcd_operation_map, attribution_assessment, counter_operation_brief) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
