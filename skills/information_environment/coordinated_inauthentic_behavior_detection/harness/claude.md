...
Return the `skill.yaml` outputs (coordination_clusters, cib_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
