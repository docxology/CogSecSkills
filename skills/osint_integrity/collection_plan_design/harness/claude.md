...
Return the `skill.yaml` outputs (collection_plan, source_priority_matrix) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
