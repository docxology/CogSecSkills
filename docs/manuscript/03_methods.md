...
- `docs/manuscript/S10_skill_catalogue.md`, a grouped catalogue of all skills with functionality, "Use when" text, verbs, inputs, outputs, AGEINT topic, reference count, and source path;
- `docs/manuscript/S11_skill_metadata_matrix.md`, a compact matrix view of group counts, verb usage, AGEINT crosswalks, harness coverage, and figure inventory;
