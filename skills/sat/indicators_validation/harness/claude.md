...
Return the `skill.yaml` outputs (validated_indicators_matrix, validation_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
