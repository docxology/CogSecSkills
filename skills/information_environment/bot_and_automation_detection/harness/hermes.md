# Hermes adapter — Bot & Automation Detection
...
Return the `skill.yaml` outputs (account_classifications, detection_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
