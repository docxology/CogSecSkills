# Claude Code adapter — Information Flow Network Analysis
...
Return the `skill.yaml` outputs (network_role_map, flow_analysis_report) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
