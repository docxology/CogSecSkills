# Hermes adapter — Outside-In Thinking
...
Return the `skill.yaml` outputs (outside_in_analysis) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
