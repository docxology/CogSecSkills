...
Return the `skill.yaml` outputs (sorted_table, outlier_flags) as Markdown, with a calibrated confidence statement. Keep the product defensive and accountable.
